...
`,ta=w(C)`
  ...
  inset: 0;
  z-index: 1;
`,He=()=>{const{formatMessage:e}=A();return t.jsx(ta,{justifyContent:"center",alignItems:"center",children:t.jsx(be,{children:e({id:"app.loading",defaultMessage:"Loading..."})})})},sa=({asset:e,actions:s,isLoading:n=!1})=>{const{formatMessage:r}=A(),{alternativeText:o,ext:a,mime:i,url:d,updatedAt:u,isUrlSigned:h,isLocal:f}=e,p=u&&!h?new Date(u).getTime():void 0,y=S=>!S||p===void 0?S:S.includes("?")?`${S}&v=${p}`:`${S}?v=${p}`,m=y(he(d)),[g,b]=c.useState(!1);c.useEffect(()=>{b(!1)},[m]);const M=c.useRef(null);if(c.useEffect(()=>{const S=M.current;if(!S)return;const j=()=>{const k=S.parentElement;if(!k)return;const R=k.getBoundingClientRect(),T=S.offsetWidth,E=S.offsetHeight;!T||!E||!R.width||R.height};j();const v=new ResizeObserver(j);return v.observe(S),S.parentElement&&v.observe(S.parentElement),()=>v.disconnect()},[g]),i?.includes(le.Image)){const S=y(he(d));if(S)return t.jsxs(ke,{children:[(!g||n)&&t.jsx(He,{}),s?t.jsx(Qr,{children:s}):null,t.jsx(Ke,{children:t.jsx(Yr,{ref:M,src:S,alt:o||e.name||"",crossOrigin:!f&&h?"anonymous":void 0,onLoad:()=>b(!0),onError:()=>b(!0)})})]})}if(i?.includes(le.Video)&&m)return t.jsxs(ke,{children:[!g&&t.jsx(He,{}),t.jsx(Ke,{children:t.jsx(Zr,{src:m,controls:!0,title:e.name,onLoadedData:()=>b(!0),onError:()=>b(!0),children:r({id:l("asset-details.videoNotSupported"),defaultMessage:"Your browser does not support the video tag."})})})]});if(i?.includes(le.Audio)&&m)return t.jsxs(ke,{children:[!g&&t.jsx(He,{}),t.jsx(Ke,{children:t.jsx(C,{width:"100%",padding:4,justifyContent:"center",alignItems:"center",height:"100%",minHeight:"12rem",children:t.jsx(Xr,{src:m,controls:!0,onLoadedData:()=>b(!0),onError:()=>b(!0)})})})]});if((a?.toLowerCase()==="pdf"||a?.toLowerCase()===".pdf"||i==="application/pdf")&&m)return t.jsxs(ke,{children:[!g&&t.jsx(He,{}),t.jsx(Ke,{children:t.jsx(Jr,{src:`${m}#toolbar=0`,title:e.name,onLoad:()=>b(!0)})})]});const x=Te(i,a);return t.jsx(ke,{children:t.jsxs(ea,{justifyContent:"center",alignItems:"center",gap:1,direction:"column",hasRadius:!0,children:[t.jsx(x,{width:24,height:24}),t.jsx($,{variant:"pi",children:r({id:l("asset-details.noPreview"),defaultMessage:"No preview available"})})]})})},at="assetId",Os=c.createContext(null),Ns=()=>{const e=c.useContext(Os);if(!e)throw new Error("useDrawerNotify must be used within AssetDetails");return e},Bs=c.createContext(null),_s=()=>{const e=c.useContext(Bs);if(!e)throw new Error("useAssetOperation must be used within AssetDetails");return e},zs=()=>{const[{query:e},s]=Me(),n=e?.[at],r=n?parseInt(n,10):null,o=r!==null&&!Number.isNaN(r),[a,i]=c.useState(o),d=c.useRef(null);c.useEffect(()=>{o&&(d.current=r,i(!0))},[o,r]);const u=c.useCallback(p=>{p.target===p.currentTarget&&!o&&i(!1)},[o]),h=c.useCallback(p=>{s({[at]:String(p)},"push",!0)},[s]),f=c.useCallback(()=>{s({[at]:void 0},"remove",!0)},[s]);return{assetId:o?r:d.current,isVisible:o,shouldRenderDrawer:a,onCloseAnimationEnd:u,openDetails:h,closeDetails:f}},na=w(C)`
...
`,Ua=({items:e})=>{const{formatMessage:s}=A();if(e.length===0)return null;if(e.length===1){const a=e[0],i=a.kind==="folder",d=i?pe:qe,u=i?it:lt;return t.jsxs(Ws,{children:[t.jsx(dt,{children:t.jsx(d,{width:u,height:u})}),t.jsx($,{textColor:"neutral800",fontWeight:"semiBold",ellipsis:!0,children:a.name})]})}const n=e.filter(a=>a.kind==="folder").length,r=e.filter(a=>a.kind==="file").length,o=n+r;return t.jsxs(_a,{gap:3,children:[n>0?t.jsxs(Gt,{children:[t.jsx(dt,{children:t.jsx(pe,{width:it,height:it})}),t.jsx($,{textColor:"neutral800",fontWeight:"semiBold",children:s({id:l("dnd.overlay.folders"),defaultMessage:"{count, plural, one {# folder} other {# folders}}"},{count:n})})]}):null,r>0?t.jsxs(Gt,{children:[t.jsx(dt,{children:t.jsx(qe,{width:lt,height:lt})}),t.jsx($,{textColor:"neutral800",fontWeight:"semiBold",children:s({id:l("dnd.overlay.files"),defaultMessage:"{count, plural, one {# file} other {# files}}"},{count:r})})]}):null,t.jsx(za,{children:t.jsx($,{textColor:"neutral0",fontWeight:"bold",variant:"pi",children:o})})]})},qs=c.createContext(null),ne=()=>c.useContext(qs),Yt=e=>{const s=Oa(e);if(s!=null)return{destinationFolderId:s};const n=Ba(e);return n==="root"?{destinationFolderId:null}:typeof n=="number"?{destinationFolderId:n}:null},Va=Number.MAX_SAFE_INTEGER,Ka=({children:e})=>{const{formatMessage:s}=A(),{toggleNotification:n}=ve(),r=Sa(),{currentFolderId:o}=Ee(),{data:a=[]}=Tt(),i=s({id:l("plugin.name"),defaultMessage:"Media Library"}),[d,{isLoading:u}]=Rs(),[h,f]=c.useState([]),[p,y]=c.useState(""),m=c.useRef({items:[],fromSelection:!1}),g=c.useCallback(E=>{y(""),requestAnimationFrame(()=>y(E))},[]),{canUpdate:b}=ae(),M=pr(fr(yr,{activationConstraint:{distance:b?8:Va}})),D=c.useMemo(()=>Ra(h,a),[h,a]),x=c.useCallback(E=>D.has(E),[D]),S=c.useMemo(()=>({isInternalDragActive:h.length>0,isMovePending:u,isValidDropTarget:x}),[h.length,u,x]),j=c.useCallback(()=>{m.current={items:[],fromSelection:!1},f([])},[]),v=c.useCallback(E=>{const z=E.active.data.current;if(!z){j();return}const{items:N,fromSelection:K}=Wt(z,r?.selectedKeys,o);m.current={items:N,fromSelection:K},f(N)},[j,o,r?.selectedKeys]),k=c.useCallback(async E=>{const{over:z}=E,{items:N,fromSelection:K}=m.current;if(j(),u||!z||N.length===0)return;const Y=Yt(z.id);if(!Y)return;const{destinationFolderId:Q}=Y;if(!we({items:N,targetFolderId:Q,folderStructure:a}))return;const se=$a(N),P=Ta({formatMessage:s,count:N.length,source:Kt(a,o,i),destination:Kt(a,Q,i)}),B=s({id:l("list.bulk-actions.move.error"),defaultMessage:"An error occurred while moving the items."});try{await d({...se,destinationFolderId:Q}).unwrap(),K&&r?.clear(),g(P),n({type:"success",message:P})}catch(H){const ee=Ks(H,B);g(s({id:l("dnd.announce.move-failure"),defaultMessage:"Move failed. {message}"},{message:ee})),n({type:"danger",message:ee})}},[g,d,j,o,a,s,u,i,r,n]),R=c.useCallback(()=>{j()},[j]),T=c.useMemo(()=>({onDragStart:({active:E})=>{const z=E.data.current;return z?s({id:l("dnd.announce.drag-start"),defaultMessage:"Picked up {name}. Drop on a folder to move."},{name:z.name}):""},onDragOver:()=>"",onDragEnd:({active:E,over:z})=>{if(!z)return s({id:l("dnd.announce.cancel"),defaultMessage:"Drag cancelled."});const N=Yt(z.id),K=E.data.current;if(!N||!K)return"";const{items:Y}=Wt(K,r?.selectedKeys,o);return we({items:Y,targetFolderId:N.destinationFolderId,folderStructure:a})?"":s({id:l("dnd.announce.invalid-drop"),defaultMessage:"Cannot move item to this folder."})},onDragCancel:()=>s({id:l("dnd.announce.cancel"),defaultMessage:"Drag cancelled."})}),[o,a,s,r?.selectedKeys]);return t.jsx(qs.Provider,{value:S,children:t.jsxs(mr,{sensors:M,collisionDetection:xr,onDragStart:v,onDragEnd:k,onDragCancel:R,accessibility:{announcements:T},children:[t.jsx(Ce,{"aria-live":"polite","aria-atomic":"true",children:p}),t.jsx(O,{position:"relative",children:e}),t.jsx(br,{dropAnimation:null,children:h.length>0?t.jsx(Ua,{items:h}):null})]})})},Ha=e=>e==null?null:typeof e=="object"?e.id??null:typeof e=="number"?e:Number(e)||null,Gs=e=>{const{isMovePending:s}=ne()??{isMovePending:!1},n=c.useMemo(()=>({kind:"file",id:e.id,name:e.name,folderId:Ha(e.folder)}),[e.folder,e.id,e.name]);return Ts({id:Fa(e.id),data:n,disabled:s})},Ys=e=>{const{isMovePending:s,isValidDropTarget:n}=ne()??{isMovePending:!1,isValidDropTarget:()=>!1},{active:r}=As(),o=typeof e.parent=="object"&&e.parent!=null?e.parent.id??null:e.parent??null,a=c.useMemo(()=>({kind:"folder",id:e.id,name:e.name,parentId:o}),[e.id,e.name,o]),i=c.useMemo(()=>({kind:"folder-target",id:e.id,name:e.name}),[e.id,e.name]),d=Ts({id:La(e.id),data:a,disabled:s}),u=Es({id:Pa(e.id),data:i,disabled:s}),h=n(e.id),f=u.isOver,p=f&&h,y=f&&!h&&r!=null;return{dragData:a,draggable:d,droppable:u,isDragging:d.isDragging,showValidDropHighlight:p,showInvalidDropCursor:y}},Wa=w(C)`
  position: absolute;
  top: ${({theme:e})=>e.spaces[3]};
...
`,Ui=()=>{const{formatMessage:e}=A(),{openDetails:s}=zs(),{canCreate:n,canUpdate:r}=ae(),{currentFolderId:o,navigateToFolderId:a,navigateToRoot:i}=Ee(),{error:d}=At({id:o},{skip:o===null});c.useEffect(()=>{d?.name==="NotFoundError"&&i()},[d,i]);const{title:u,itemCount:h}=Ps(o),{searchQuery:f,isSearching:p,clearSearch:y}=Qs(),m=Ti(),g=Qo(),b=c.useMemo(()=>ti(g.filters,new Date),[g.serialized]),{assets:M,pagination:D,isLoading:x,isFetchingMore:S,hasNextPage:j,fetchNextPage:v,error:k}=Ii({folder:o,search:f||void 0,sort:m.assetsSort,filters:b.fileClauses,filtersKey:g.serialized,enabled:b.showFiles}),{data:R=[],isLoading:T}=Cr({parentId:o,search:f||void 0,sort:m.foldersSort,filters:b.folderClauses},{skip:!b.showFolders}),E=c.useMemo(()=>b.showFolders?R:[],[b.showFolders,R]),z=e(Pi,{count:h}),N=e({id:l("header.search-results"),defaultMessage:'Search results for "{query}"'},{query:f}),K=E.length,Y=D?.total??0,Q=e(Oi(K,Y),{numberFolders:K,numberAssets:Y});let se;p?se=`${N} (${Q})`:u?se=`${u} (${z})`:se=e({id:"app.loading",defaultMessage:"Loading..."});const[P,B]=c.useState(!1),[H,ee]=tr(go.view,Ie.GRID),xe=H===Ie.GRID,[re,Re]=c.useState(!1),Fe=c.useRef(null),Le=c.useRef(null),[tt]=sr(),[Pe]=nr(),{data:oe}=Fs(),Se=oe?.data?.concurrentUploadRequests??1,{isEnabled:De}=Is(),I=async(U,ce)=>{if(U.length===0)return;const $e=new FormData,Oe=[];U.forEach(Ne=>{$e.append("files",Ne),Oe.push({name:Ne.name,caption:null,alternativeText:null,folder:ce})}),$e.append("fileInfo",JSON.stringify(Oe));try{await tt({formData:$e,totalFiles:U.length,concurrency:Se,generateAiMetadata:!!De}).unwrap()}catch{}},F=()=>{Fe.current?.click()},L=async U=>{const ce=U.target.files;ce&&ce.length>0&&await I(Array.from(ce),o),U.target.value=""},X=async U=>{n&&await I(U,o)},J=async U=>{try{await Pe({urls:U,folderId:o,generateAiMetadata:!!De}).unwrap()}catch{}},ie=Ei({folderId:o,search:f,sort:`${m.assetsSort};folders=${m.foldersPosition}`,filter:g.serialized||null});return t.jsxs(t.Fragment,{children:[t.jsx(Ro,{onDrop:X,disabled:!n,children:t.jsx(Ca,{disabled:!r,children:t.jsxs(Ka,{children:[t.jsx(Bi,{listQueryKey:ie}),t.jsx(O,{ref:Le,children:t.jsxs(st.Root,{minHeight:"100vh",background:"neutral0",sideNav:t.jsx(Si,{currentFolderId:o,showActiveFolder:!p,onSelectFolder:a}),children:[t.jsx(Ce,{children:t.jsx("input",{type:"file",ref:Fe,onChange:L,multiple:!0})}),t.jsx(zi,{children:t.jsx(st.Header,{title:se,primaryAction:n&&t.jsxs(or,{popoverPlacement:"bottom-end",variant:"default",endIcon:t.jsx(kt,{}),label:e({id:l("new"),defaultMessage:"New"}),children:[t.jsx(nt,{onSelect:()=>B(!0),startIcon:t.jsx(pe,{}),children:e({id:l("folder.create.title"),defaultMessage:"New folder"})}),t.jsx(nt,{onSelect:F,startIcon:t.jsx(ir,{}),children:e({id:l("import-files"),defaultMessage:"Import files"})}),t.jsx(nt,{onSelect:()=>Re(!0),startIcon:t.jsx(Mt,{}),children:e({id:l("import-from-url"),defaultMessage:"Import from URL"})})]}),subtitle:t.jsxs(t.Fragment,{children:[t.jsxs(C,{justifyContent:"space-between",alignItems:"center",gap:4,width:"100%",children:[t.jsxs(C,{gap:4,alignItems:"center",children:[t.jsx(oi,{listFilters:g}),t.jsx(uo,{})]}),t.jsxs(C,{gap:4,alignItems:"center",children:[t.jsx(ki,{sort:m,showFoldersGroup:!xe}),t.jsxs(_i,{type:"single",value:xe?"grid":"table",onValueChange:U=>U&&ee(U==="grid"?Ie.GRID:Ie.TABLE),"aria-label":e({id:l("view.switch.label"),defaultMessage:"View options"}),children:[t.jsxs(ys,{value:"table","aria-label":e({id:l("view.table"),defaultMessage:"Table view"}),children:[t.jsx(rr,{}),e({id:l("view.table"),defaultMessage:"Table view"})]}),t.jsxs(ys,{value:"grid","aria-label":e({id:l("view.grid"),defaultMessage:"Grid view"}),children:[t.jsx(ar,{}),e({id:l("view.grid"),defaultMessage:"Grid view"})]})]})]})]}),t.jsx(gi,{listFilters:g})]})})}),t.jsx(st.Content,{children:t.jsxs(Po,{children:[t.jsx(No,{uploadDropZoneRef:Le,folderName:u}),t.jsx(Ni,{view:H,folders:E,isLoadingFolders:T,assets:M,isLoadingAssets:x,isFetchingMore:S,hasNextPage:j,fetchNextPage:v,error:k,searchQuery:f,assetsSort:m.assetsSort,foldersPosition:m.foldersPosition,hasActiveFilters:g.filters.length>0,onClearFilters:g.clearFilters,onAssetItemClick:s,onAddAssets:F,canAddAssets:n,onClearSearch:y})]})})]})})]})})}),t.jsx(To,{open:P,folderName:u,parentFolderId:o,onClose:()=>B(!1)}),t.jsx(Di,{open:re,onClose:()=>Re(!1),onUpload:J}),t.jsx(ba,{})]})},Gi=()=>{const{formatMessage:e}=A(),s=e({id:l("plugin.name"),defaultMessage:"Media Library"});return t.jsxs(_t.Main,{children:[t.jsx(_t.Title,{children:s}),t.jsx(ur,{children:t.jsx(gr,{index:!0,element:t.jsx(Ui,{})})})]})};export{Gi as UnstableMediaLibrary};
